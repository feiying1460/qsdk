 ...
 /* FLOW */
#ifdef IN_FLOW
    {
        "flow", "config flow",
        {
            ...
            {"age", "set", "set flow age timer", "", SW_API_FLOW_AGE_TIMER_SET, NULL},
            {"age", "get", "get flow age timer", "", SW_API_FLOW_AGE_TIMER_GET, NULL},
...
#ifdef IN_QM
    {
	    ...
	    {"acsthresh", "set", "set ac static thresh", "<obj> <cfg>", SW_API_STATIC_THRESH_SET, NULL},
	    {"acsthresh", "get", "get ac static thresh", "<obj>", SW_API_STATIC_THRESH_GET, NULL},
	    {"acdthresh", "set", "set ac dynamic thresh", "<queue_id> <cfg>", SW_API_DYNAMIC_THRESH_SET, NULL},
	    {"acdthresh", "get", "get ac dynamic thresh", "<queue_id>", SW_API_DYNAMIC_THRESH_GET, NULL},
	    {"acgbuff", "set", "set ac group buffer", "<group_id> <cfg>", SW_API_GOURP_BUFFER_SET, NULL},
	    {"acgbuff", "get", "get ac group buffer", "<group_id>", SW_API_GOURP_BUFFER_GET, NULL},

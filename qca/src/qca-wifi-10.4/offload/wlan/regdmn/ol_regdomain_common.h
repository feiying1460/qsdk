...
static const COUNTRY_CODE_TO_ENUM_RD ahCmnAllCountries[] = {
    ...
    {CTRY_IRAN,        APL1_WORLD,    "IR", "IRAN",           YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, 7000 },
...
/*    {CTRY_JAPAN56,     MKK5_FCCA,     "JP", "JAPAN56",        YES,  NO,  NO, YES, YES, YES, YES, YES, YES, YES, 7000 },*/
    ...
    {CTRY_KOREA_NORTH, APL9_WORLD,    "KP", "NORTH KOREA",    YES,  NO,  NO, YES,  NO, YES,  NO, NO, NO, NO, 7000 },
    ...
    {CTRY_SYRIA,       NULL1_WORLD,   "SY", "SYRIAN ARAB REPUBLIC", YES,  NO, YES, YES, YES,  NO,  NO, NO, NO, NO, 7000 },

...
#else
#if FW_CODE_SIGN
#define A_REQUEST_FIRMWARE(_ppf, _pfile, _dev) request_secure_firmware(_ppf, _pfile, _dev, __pci_dev_id)
#define A_RELEASE_FIRMWARE(_pf) release_secure_firmware(_pf)
#else
 ...
 */
#if defined(CONFIG_AR9888_SUPPORT) || defined(CONFIG_AR6320_SUPPORT) || defined(CONFIG_AR900B_SUPPORT)

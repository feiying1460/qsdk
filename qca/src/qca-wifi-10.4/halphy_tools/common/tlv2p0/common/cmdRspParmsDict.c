...
PARM_DICT ParmDict[] = {
    ...
    {PARM_FREQ2G_RAND, {(A_UINT32)PARM_FREQ2GArray}, 15, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_NUMFREQ5G_RAND, {(A_UINT32)8}, 13, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_FREQ5G_RAND, {(A_UINT32)PARM_FREQ5GArray}, 22, DATATYPE(PARM_U8, TYPE_ARRAY)},
    ...
    {PARM_MEASUREDPWR_RAND, {(A_UINT32)PARM_MEASUREDPWRArray}, 1, DATATYPE(PARM_S16, TYPE_ARRAY)},
    {PARM_NUMMEASUREDPWR_RAND, {(A_UINT32)32}, 11, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_CALDATA2G_RAND, {(A_UINT32)NULL}, 6, DATATYPE(PARM_DATA_256, TYPE_DATA)},
    {PARM_CALDATA2GOFFSET_RAND, {(A_UINT32)10}, 17, DATATYPE(PARM_U16, TYPE_SINGULAR)},
    {PARM_CALDATA5G_RAND, {(A_UINT32)NULL}, 27, DATATYPE(PARM_DATA_512, TYPE_DATA)},
    ...
    {PARM_CALPT2G_RAND, {(A_UINT32)parm_calPt}, 11, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_NUMTXGAINS2G_RAND, {(A_UINT32)13}, 11, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_TXGAINS2G_RAND, {(A_UINT32)parm_txGains}, 13, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_NUMDACGAINS2G_RAND, {(A_UINT32)13}, 9, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_DACGAINS2G_RAND, {(A_UINT32)parm_dacGains}, 11, DATATYPE(PARM_U8, TYPE_ARRAY)}, 
    {PARM_NUMPACFG2G_RAND, {(A_UINT32)13}, 18, DATATYPE(PARM_U8, TYPE_SINGULAR)},  
    {PARM_PACFG2G_RAND, {(A_UINT32)parm_paCfg}, 12, DATATYPE(PARM_U8, TYPE_ARRAY)}, 
    {PARM_CHAINMASKS_RAND, {(A_UINT32)parm_chainMasks}, 2, DATATYPE(PARM_U8, TYPE_ARRAY)}, 
    {PARM_NUMCALPT5G_RAND, {(A_UINT32)13}, 2, DATATYPE(PARM_U8, TYPE_SINGULAR)}, 
    {PARM_CALPT5G_RAND, {(A_UINT32)parm_calPt}, 32, DATATYPE(PARM_U8, TYPE_ARRAY)}, 
    {PARM_NUMTXGAINS5G_RAND, {(A_UINT32)13}, 32, DATATYPE(PARM_U8, TYPE_SINGULAR)}, 
    {PARM_TXGAINS5G_RAND, {(A_UINT32)parm_txGains5G}, 34, DATATYPE(PARM_U8, TYPE_ARRAY)}, 
    {PARM_NUMDACGAINS5G_RAND, {(A_UINT32)13}, 30, DATATYPE(PARM_U8, TYPE_SINGULAR)}, 
    {PARM_DACGAINS5G_RAND, {(A_UINT32)parm_dacGains5G}, 32, DATATYPE(PARM_U8, TYPE_ARRAY)}, 
    {PARM_NUMPACFG5G_RAND, {(A_UINT32)13}, 3, DATATYPE(PARM_U8, TYPE_SINGULAR)}, 
    {PARM_PACFG5G_RAND, {(A_UINT32)parm_paCfg5G}, 33, DATATYPE(PARM_U8, TYPE_ARRAY)}, 
    {PARM_MISCFLAGS_RAND, {(A_UINT32)0x80}, 27, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_TGTPWR2G_RAND, {(A_UINT32)parm_tgtPwr2G}, 19, DATATYPE(PARM_S16, TYPE_ARRAY)},
    {PARM_TGTPWR5G_RAND, {(A_UINT32)parm_tgtPwr5G}, 4, DATATYPE(PARM_S16, TYPE_ARRAY)},
    {PARM_CALDATA2G_CLPC_RAND, {(A_UINT32)NULL}, 33, DATATYPE(PARM_DATA_256, TYPE_DATA)},
    {PARM_CALDATA2GOFFSET_CLPC_RAND, {(A_UINT32)40}, 10, DATATYPE(PARM_U16, TYPE_SINGULAR)},
    {PARM_CALDATA5G_CLPC_RAND, {(A_UINT32)NULL}, 0, DATATYPE(PARM_DATA_512, TYPE_DATA)},
    ...
    {PARM_DATAPATTERN_RAND, {(A_UINT32)PARM_DATAPATTERNArray}, 27, DATATYPE(PARM_U8, TYPE_ARRAY)},
    ...
    {PARM_PAD3_RAND, {(A_UINT32)PARM_PAD3Array}, 9, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_RATEMASK_RAND, {(A_UINT32)PARM_RATEMASKArray}, 2, DATATYPE(PARM_U32, TYPE_ARRAY)},
    {PARM_RATEMASK11AC_RAND, {(A_UINT32)PARM_RATEMASK11ACArray}, 13, DATATYPE(PARM_U32, TYPE_ARRAY)},
    {PARM_PWRGAINSTART_RAND, {(A_UINT32)PARM_PWRGAINSTARTArray}, 4, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PWRGAINEND_RAND, {(A_UINT32)PARM_PWRGAINENDArray}, 24, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PWRGAINSTEP_RAND, {(A_UINT32)PARM_PWRGAINSTEPArray}, 26, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PWRGAINSTART11AC_RAND, {(A_UINT32)PARM_PWRGAINSTART11ACArray}, 5, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PWRGAINEND11AC_RAND, {(A_UINT32)PARM_PWRGAINEND11ACArray}, 21, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PWRGAINSTEP11AC_RAND, {(A_UINT32)PARM_PWRGAINSTEP11ACArray}, 23, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_BSSID_RAND, {(A_UINT32)PARM_BSSIDArray}, 15, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_TXSTATION_RAND, {(A_UINT32)PARM_TXSTATIONArray}, 10, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_RXSTATION_RAND, {(A_UINT32)PARM_RXSTATIONArray}, 1, DATATYPE(PARM_U8, TYPE_ARRAY)},
    ...
    {PARM_RSSIC_RAND, {(A_UINT32)PARM_RSSICArray}, 1, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_RSSIE_RAND, {(A_UINT32)PARM_RSSIEArray}, 20, DATATYPE(PARM_S32, TYPE_ARRAY)},
    ...
    {PARM_PAD2_RAND, {(A_UINT32)PARM_PAD2Array}, 11, DATATYPE(PARM_U8, TYPE_ARRAY)},
    ...
    {PARM_REGDMN_RAND, {(A_UINT32)PARM_REGDMNArray}, 24, DATATYPE(PARM_U16, TYPE_ARRAY)},
    ...
    {PARM_STAADDR_RAND, {(A_UINT32)PARM_STAADDRArray}, 26, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_BTADDR_RAND, {(A_UINT32)PARM_BTADDRArray}, 27, DATATYPE(PARM_U8, TYPE_ARRAY)},
    ...
    {PARM_BADRSSIC_RAND, {(A_UINT32)PARM_BADRSSICArray}, 19, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_BADRSSIE_RAND, {(A_UINT32)PARM_BADRSSIEArray}, 34, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_EVM_RAND, {(A_UINT32)0}, 2, DATATYPE(PARM_S32, TYPE_SINGULAR)},
    {PARM_BADEVM_RAND, {(A_UINT32)PARM_BADEVMArray}, 27, DATATYPE(PARM_S32, TYPE_ARRAY)},
    ...
    {PARM_RATECNT_RAND, {(A_UINT32)NULL}, 24, DATATYPE(PARM_U32, TYPE_ARRAY)},
    {PARM_RATECNT11AC_RAND, {(A_UINT32)NULL}, 23, DATATYPE(PARM_U32, TYPE_ARRAY)},
    ...
    {PARM_CUSTDATA_RAND, {(A_UINT32)NULL}, 5, DATATYPE(PARM_U8, TYPE_ARRAY)},
    ...
    {PARM_MEMVALUE_RAND, {(A_UINT32)NULL}, 2, DATATYPE(PARM_U8, TYPE_ARRAY)},
    ...
    {PARM_CALOPORDER_RAND, {(A_UINT32)NULL}, 7, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_PAD1_RAND, {(A_UINT32)0x0}, 9, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_RATESHORTG_RAND, {(A_UINT32)NULL}, 22, DATATYPE(PARM_U32, TYPE_ARRAY)},
    {PARM_RATESHORTG11AC_RAND, {(A_UINT32)NULL}, 17, DATATYPE(PARM_U32, TYPE_ARRAY)},
    ...
    {PARM_WLANMODEMASK_RAND, {(A_UINT32)PARM_WLANMODEMASKArray}, 26, DATATYPE(PARM_U32, TYPE_ARRAY)},
    {PARM_FLAG_RAND, {(A_UINT32)1}, 25, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_LM_RESVD0_RAND, {(A_UINT32)NULL}, 19, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_LM_FREQ_RAND, {(A_UINT32)PARM_LM_FREQArray}, 34, DATATYPE(PARM_U16, TYPE_ARRAY)},
    {PARM_LM_FREQ2_RAND, {(A_UINT32)PARM_LM_FREQ2Array}, 7, DATATYPE(PARM_U16, TYPE_ARRAY)},
    {PARM_LM_CHAINMASK_RAND, {(A_UINT32)PARM_LM_CHAINMASKArray}, 11, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_LM_BANDWIDTH_RAND, {(A_UINT32)PARM_LM_BANDWIDTHArray}, 1, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_LM_RESVD1_RAND, {(A_UINT32)NULL}, 29, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_RSSIINDBM_RAND, {(A_UINT32)0}, 9, DATATYPE(PARM_S32, TYPE_SINGULAR)},
    {PARM_PWRGAINSTARTAC160_RAND, {(A_UINT32)PARM_PWRGAINSTARTAC160Array}, 6, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PWRGAINENDAC160_RAND, {(A_UINT32)PARM_PWRGAINENDAC160Array}, 4, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PWRGAINSTEPAC160_RAND, {(A_UINT32)PARM_PWRGAINSTEPAC160Array}, 20, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_HWCALTIME_RAND, {(A_UINT32)0}, 20, DATATYPE(PARM_U16, TYPE_SINGULAR)},
    {PARM_WLANMODEMASKEXT_RAND, {(A_UINT32)PARM_WLANMODEMASKEXTArray}, 4, DATATYPE(PARM_U32, TYPE_ARRAY)},
    ...
    {PARM_DATAI_RAND, {(A_UINT32)NULL}, 33, DATATYPE(PARM_U16, TYPE_ARRAY)},
    {PARM_DATAQ_RAND, {(A_UINT32)NULL}, 34, DATATYPE(PARM_U16, TYPE_ARRAY)},
    ...
    {PARM_GAINLUT_RAND, {(A_UINT32)NULL}, 35, DATATYPE(PARM_U16, TYPE_ARRAY)},
    {PARM_RFDOCLUT_RAND, {(A_UINT32)NULL}, 23, DATATYPE(PARM_U16, TYPE_ARRAY)},
    {PARM_BBDOCLUT_RAND, {(A_UINT32)NULL}, 32, DATATYPE(PARM_U16, TYPE_ARRAY)},
    {PARM_INPUTTABLE2SWPROCESSING_RAND, {(A_UINT32)NULL}, 13, DATATYPE(PARM_U16, TYPE_ARRAY)},
    ...
    {PARM_HWPROCESSEDTABLE_RAND, {(A_UINT32)NULL}, 1, DATATYPE(PARM_U16, TYPE_ARRAY)},    
    {PARM_CMDIDRXDCOGROUP_RAND, {(A_UINT32)0}, 24, DATATYPE(PARM_U8, TYPE_SINGULAR)},
    {PARM_NOISEFLOORARR_RAND, {(A_UINT32)NULL}, 10, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_PILOTEVM_RAND, {(A_UINT32)NULL}, 28, DATATYPE(PARM_S32, TYPE_ARRAY)},
    ...
    {PARM_LM_CBSTATE_RAND, {(A_UINT32)NULL}, 19, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_LM_TXPOWER_RAND, {(A_UINT32)NULL}, 28, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_LM_PHYID_RAND, {(A_UINT32)NULL}, 24, DATATYPE(PARM_U8, TYPE_ARRAY)},
    {PARM_LM_RATEINDEX_RAND, {(A_UINT32)NULL}, 21, DATATYPE(PARM_U16, TYPE_ARRAY)},
    ...
    {PARM_INPARAMS_RAND, {(A_UINT32)NULL}, 0, DATATYPE(PARM_S32, TYPE_ARRAY)},
    ...
    {PARM_GENERICUTFCMDRETDATA_RAND, {(A_UINT32)NULL}, 16, DATATYPE(PARM_S32, TYPE_ARRAY)},
    {PARM_NFVALUES_RAND, {(A_UINT32)NULL}, 14, DATATYPE(PARM_U32, TYPE_ARRAY)},
};

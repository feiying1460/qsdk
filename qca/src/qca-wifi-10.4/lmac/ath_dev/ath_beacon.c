...
#endif
{
    ...
    */
    ...
    if (avp->av_txpow_mgt_frm[IEEE80211_FC0_SUBTYPE_BEACON >> IEEE80211_FC0_SUBTYPE_SHIFT] != 0xFF){
        ...
        series[0].tx_power_cap = ( series[0].tx_power_cap <= sc->txpow_mgt_frm[IEEE80211_FC0_SUBTYPE_BEACON >> IEEE80211_FC0_SUBTYPE_SHIFT])?
            series[0].tx_power_cap  : sc->txpow_mgt_frm[IEEE80211_FC0_SUBTYPE_BEACON >> IEEE80211_FC0_SUBTYPE_SHIFT];
    }

...
#endif
    { ATH_PARAM_TXPOW_MGMT | ATH_PARAM_SHIFT, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 2,
      0, "set_txpow_mgmt" },
    { ATH_PARAM_TXPOW_MGMT | ATH_PARAM_SHIFT, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,
                           ...
                           char *extra)
{
    ...
    if (param == (ATH_PARAM_TXPOW_MGMT | ATH_PARAM_SHIFT)) {
        ...
        if( !(txpow_mgmt_frm_valid(i[1],i[2],&value)) ) {
...
static int ath_iw_getparam(struct net_device *dev, struct iw_request_info *info, void *w, char *extra)
{
    ...
    if (val[0] == (ATH_PARAM_TXPOW_MGMT | ATH_PARAM_SHIFT)) {
        ...
        return ath_ucfg_getparam(scn, val[0], val);
    }

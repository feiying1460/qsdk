...
/**
 * @brief Set a bit in memory
 */
#define adf_os_set_bit(nr, addr)                __adf_os_set_bit(nr, addr)

/**
 * @brief Clears a bit in memory
 */
#define adf_os_clear_bit(nr, addr)              __adf_os_clear_bit(nr, addr)

/**
 * @brief Set a bit and return its old value
 */
#define adf_os_test_and_set_bit(nr, addr)       __adf_os_test_and_set_bit(nr, addr)

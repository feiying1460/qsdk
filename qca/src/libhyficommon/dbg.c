 ...
 */
void dbgTimeStampMake(char* Buf, size_t bufSize)
{
    #if DBG_TIME_STAMP_HHMMSS() || DBG_TIME_STAMP_HHMMSSUUUUUU()
    {
        ...
        snprintf(Buf, bufSize,  "%02u.%02u.%02u.%06ld ", hour, minute, second, tp.tv_usec);
        #else
        snprintf(Buf,  bufSize, "%02u.%02u.%02u ", hour, minute, second);
        #endif
    }
        ...
        ...)    /* printf-like args */
{
    ...
    dbgTimeStampMake(TimeBuf, sizeof(TimeBuf));
